// CREDITS: https://www.codeproject.com/Articles/4502/RegistryMonitor-a-NET-wrapper-class-for-RegNotifyC
// UPDATE to avoid deprecation warnings at compile time.
...
namespace RegistryUtils
{
	...
	public class RegistryMonitor : IDisposable
	{
		...
		private static extern int RegNotifyChangeKeyValue(IntPtr hKey, bool bWatchSubtree,
		                                                  RegChangeNotifyFilter dwNotifyFilter, /* IntPtr */SafeHandle hEvent,
		                                                  bool fAsynchronous);
		...
		private void ThreadLoop()
		{
			...
			try
			{
				...
				{
					result = RegNotifyChangeKeyValue(registryKey, true, _regFilter, _eventNotify./* Handle */SafeWaitHandle, true);
					if (result != 0)
						throw new Win32Exception(result);
